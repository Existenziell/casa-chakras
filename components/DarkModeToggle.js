  ...
  return (
    <button className='bg-brand/80 dark:bg-brand-dark/80 p-1 rounded w-[50px] h-[50px] flex items-center justify-center z-20 transition-all'>
      {darkmode === 'light' ?
        ...
        :
        <svg onClick={setLight} xmlns='http://www.w3.org/2000/svg' className='h-10 w-10 p-0 cursor-pointer text-brand-dark dark:text-brand hover:text-white dark:hover:text-white' fill='none' viewBox='0 0 24 24' stroke='currentColor'>
