...
const sendMail = async (req, res) => {
  ...
  const notificationMsg = {
    ...
    subject: `Contact request on Casa Chakras`,
  ...
  const confirmationMsg = {
    to: email,
    from: process.env.NEXT_PUBLIC_MAIL_FROM,
    subject: `Confirmation | Casa Chakras`,
    text: `Hello ${name},\nThis is a confirmation, that your message to Casa Chakras has indeed been received successfully.\nWe'll come back to you as soon as possible.\nThank you so much.\nCasa Chakras Cozumel`,
    html,
  }
